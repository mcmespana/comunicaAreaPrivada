...
$formSettings['title'] = __('Session', 'sticpa'); // form title
$formSettings['moduleName'] = 'stic_Sessions'; // module name, case sensitive
...
switch ($_REQUEST['action']) {
    ...
    case 'edit':
        ...
        $formSettings['submitButtonActions']['back'] = array(
            'onclick' => "location.href='?internalpage=list_stic_sessions';",
        );
