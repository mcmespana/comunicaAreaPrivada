...
switch (getDestinationModule()) {
    case 'Accounts':
        $listSettings['moduleName'] = 'stic_Accounts_Relationships'; // module name, case sensitive
...
$listSettings['title'] = __('Relationships with the organization', 'sticpa'); // list title
$listSettings['linkDestination'] = '?internalpage=single_stic_relationships&action=create'; //The link destination of each record in the list
$listSettings['actions'] = array(
    // array('label' => __('Edit', 'sticpa'), 'link' => '?internalpage=single_stic_relationships&action=edit'),
    array('label' => __('View', 'sticpa'), 'link' => '?internalpage=single_stic_relationships&action=detail'),
    // array('label' => __('Delete', 'sticpa'), 'link' => '?internalpage=single_stic_relationships&action=delete'),
);
// $listSettings['createButton'] = array('value' => true, 'label' => __('New relationship', 'sticpa')); // show create button and its label
...
$columnsList[] = array('name' => 'relationship_type', 'format' => 'enum');
