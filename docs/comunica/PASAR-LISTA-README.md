...
| `single_stic_pasar_lista_monitores`, `_monitor`, `_reuniones` | sin artboard todavía — el diseño de `_monitor` está escrito en [`PASAR-LISTA-COORDINACION.md`](PASAR-LISTA-COORDINACION.md) §4 y en [`../../plans/archive/038-seguimiento-de-monitores.md`](../../plans/archive/038-seguimiento-de-monitores.md) |
