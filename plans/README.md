...
| 003 | Asegurar ver/descargar documentos + validar subidas | P0 | M | 001 | **HECHO** (24/09) — descargar/editar/borrar y las fichas de pago, compromiso, inscripción y documento exigen que el registro salga en TU listado. Subidas: 6 MB y lista de extensiones. Queda fuera `single_stic_sessions` (sesiones de un evento, sin datos personales) |
