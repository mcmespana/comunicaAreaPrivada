...
| 039 | Unificar el lenguaje visual MCM (tokens, breakpoints, deuda de diseño) | P2 | S por fila | — | **TODO** — 2 de 9 filas hechas (CAMPOS.md ya se sincroniza solo). Sale de escribir [`../design.md`](../design.md) |
